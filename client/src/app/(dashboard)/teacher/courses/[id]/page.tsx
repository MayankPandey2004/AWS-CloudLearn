...
import { centsToDollars, courseCategories, createCourseFormData, uploadAllVideos } from '@/lib/utils';
    ...
    return (
        <div>
            <div className='flex items-center gap-5 mb-5'>
                <button
                    className='flex items-center border border-customgreys-dirtyGrey'
                    ...
                    <div className='flex justify-between md:flex-row flex-col gap-10 mt-5 font-dm-sans'>
                        ...
                        <div className='bg-customgreys-darkGrey mt-4 md:mt-0 p-4 rounded-lg basis-1/2'>
                            <div className='flex justify-between items-center mb-2'>
                                <h2 className='text-2xl text-white-100 font-semibold text-secondary-foreground'>
                                    Sections
                                </h2>
                                ...
                                <Button
                                    ...
                                    className='border-none bg-customgreys-darkGrey text-primary-700 group'
                                >
