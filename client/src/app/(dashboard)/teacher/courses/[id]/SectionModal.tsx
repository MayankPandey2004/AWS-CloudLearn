...
import { addSection, closeChapterModal, closeSectionModal, editChapter, editSection } from '@/state';
...
const SectionModal = () => {
    ...
    const onSubmit = (data: SectionFormData) => {
        ...
        toast.success(
            "Section added/updated succesfully but you need to sane the course to apply the changes"
        )
        onClose();
    }
    return (
