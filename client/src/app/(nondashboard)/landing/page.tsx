    ...
    return(
        <div className="landing-skeleton">
            <div className='landing-skelton__hero'>
                <div className="landing-skeleton__hero-contnet">
    ...
    >
        ...
        >
            ...
            <p className="landing__featured-description">
                From beginners to advanced in all industries, we have the right courses just for you and preparing your entire journey for learning and making the most.
            </p>
