                        ...
                        >
                            <div className='app-sidebar__logo-container group'>
                                <div className='app-sidebar__logo-wrapper'>
                                    ...
                                    />
                                    <p className='app-sidebar__title text-white-50'>CloudLearn</p>
                                </div>
                    ...
                    {currentNavLinks.map((link) => {
                        ...
                        return (
                            <SidebarMenuItem
                                key={link.href}
                                className={cn(
                                    "app-sidebar__nav-item hover:!bg-customgreys-secondarybg",
                                ...
                                <SidebarMenuButton
                                    ...
                                    size="lg"
                                    className={cn(
                                        "app-sidebar__nav-button hover:bg-transparent",
